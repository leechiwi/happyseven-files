...
import org.leechiwi.happyseven.files.text.ap.ApWordText;
...
public class ApWordTextTest {
    @Test
    public void convert() {
        FileOutputStream out=null;
        try {
            out = new FileOutputStream(new File("d:/test.zip"));
            boolean convert = new ApWordText("d:/test.txt", ResultOptions.ALL_IN_ZIP).convertAll(out, TextConvertType.JPEG,new OptionResult());
